...
interface Props {
  params: Promise<{ region: string; slug: string; locale: string }>
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const post = await getPostBySlug(slug, undefined, locale)
